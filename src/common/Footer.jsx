        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-xl">Expense Tracker</h3>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Making financial management simple and effective for everyone. Track, analyze, and optimize your spending.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © {currentYear} Expense Tracker. All rights reserved. Made with 💜 for better financial management
            </p>
